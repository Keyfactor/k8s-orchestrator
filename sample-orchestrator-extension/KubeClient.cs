...
public class KubeCertificateManagerClient
{
    ...
    public V1Secret CreateCertificateStoreSecret(string[] key_pems, string[] cert_pems,string[] ca_cert_pems, string[] chain_pems, int kfid, string secretName, string namespaceName)
    {
