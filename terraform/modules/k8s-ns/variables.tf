...
variable "store_path" {
  description = "The store path for the certificate store. For K8SNS this represents a single namespace."
  type        = string
}
...
variable "kube_namespace" {
  description = "The Kubernetes namespace to manage. Overrides the namespace parsed from store_path."
  type        = string
  default     = null
}
