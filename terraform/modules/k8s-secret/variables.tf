...
variable "kube_namespace" {
  description = "The Kubernetes namespace containing the Opaque secret. Overrides the namespace parsed from store_path."
  type        = string
  default     = null
}

variable "kube_secret_name" {
  description = "The name of the Kubernetes Opaque secret. Overrides the secret name parsed from store_path."
  type        = string
  default     = null
}
