...
# STORE PASSWORD
#
# PKCS12 keystores require a password. Provide EITHER:
...
variable "kube_secret_name" {
  description = "The name of the Kubernetes secret containing the PKCS12 data. Overrides the secret name parsed from store_path."
  type        = string
  default     = null
}

variable "certificate_data_field_name" {
  description = "The field name in the K8S secret that contains the PKCS12 keystore data."
  type        = string
  default     = ".p12"
}
