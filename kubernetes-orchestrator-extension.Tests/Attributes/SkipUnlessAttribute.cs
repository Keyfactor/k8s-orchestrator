...
/// <summary>
/// Custom xUnit attribute that skips test execution unless a specified environment variable is set to "true".
/// </summary>
/// <example>
/// [SkipUnless(EnvironmentVariable = "RUN_INTEGRATION_TESTS")]
/// public void MyIntegrationTest() { ... }
/// </example>
public class SkipUnlessAttribute : FactAttribute
{
    /// <summary>
    ...
    public override string Skip
    {
        get
        {
            ...
            {
                return "SkipUnless attribute requires EnvironmentVariable property to be set";
            }
