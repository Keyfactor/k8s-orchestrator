...
/// <summary>
/// Inventory job for namespace-level certificate management.
/// Discovers all Opaque and TLS secrets within a single namespace.
/// </summary>
public class Inventory : InventoryBase
{
    /// <summary>
    /// Creates a new namespace inventory job with the specified PAM resolver.
    /// </summary>
