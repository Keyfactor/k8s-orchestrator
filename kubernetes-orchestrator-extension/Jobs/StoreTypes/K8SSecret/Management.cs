...
/// <summary>
/// Management job for Kubernetes Opaque secrets containing PEM certificates.
/// Handles Add and Remove operations for Opaque secrets.
/// </summary>
public class Management : ManagementBase
{
    /// <summary>
    /// Creates a new Opaque secret management job with the specified PAM resolver.
    /// </summary>
