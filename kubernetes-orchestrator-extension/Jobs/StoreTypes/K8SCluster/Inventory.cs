...
/// <summary>
/// Inventory job for cluster-wide certificate management.
/// Discovers all Opaque and TLS secrets across all namespaces in the cluster.
/// </summary>
public class Inventory : InventoryBase
{
    /// <summary>
    /// Creates a new cluster inventory job with the specified PAM resolver.
    /// </summary>
