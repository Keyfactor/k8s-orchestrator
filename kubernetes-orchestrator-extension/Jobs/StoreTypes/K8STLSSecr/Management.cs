...
/// <summary>
/// Management job for Kubernetes TLS secrets (kubernetes.io/tls type).
/// Handles Add and Remove operations for TLS certificates.
/// </summary>
public class Management : ManagementBase
{
    /// <summary>
    /// Creates a new TLS secret management job with the specified PAM resolver.
    /// </summary>
