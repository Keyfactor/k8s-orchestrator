...
/// <summary>
/// Discovery job for Java KeyStore (JKS) files in Kubernetes Opaque secrets.
/// Finds secrets containing JKS data in specified namespaces.
/// </summary>
public class Discovery : DiscoveryBase
{
    /// <summary>
    /// Creates a new JKS discovery job with the specified PAM resolver.
    /// </summary>
    ...
    /// <inheritdoc />
    protected override string[] GetDefaultAllowedKeys() => AllowedKeys.JksKeys;

    /// <inheritdoc />
    protected override string GetSecretTypeFilter() => "jks";
