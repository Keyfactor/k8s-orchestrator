...
/// <summary>
/// Management job for Java KeyStore (JKS) files stored in Kubernetes Opaque secrets.
/// Handles Add and Remove operations for JKS keystores.
/// </summary>
public class Management : ManagementBase
{
    /// <summary>
    /// Creates a new JKS management job with the specified PAM resolver.
    /// </summary>
