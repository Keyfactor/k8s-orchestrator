...
/// <summary>
/// Management job for PKCS12/PFX files stored in Kubernetes Opaque secrets.
/// Handles Add and Remove operations for PKCS12 keystores.
/// </summary>
public class Management : ManagementBase
{
    /// <summary>
    /// Creates a new PKCS12 management job with the specified PAM resolver.
    /// </summary>
