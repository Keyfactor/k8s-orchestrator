...
internal class Pkcs12CertificateStoreSerializerV2 : CertificateStoreSerializer
{
    ...
    public Pkcs12CertificateStoreSerializerV2(byte[] storeContent, string storePassword, string storePath = null) : base(
