...
public class K8SJobCertificate
{
    ...
    /// <summary>BouncyCastle X509CertificateEntry containing the certificate.</summary>
    public X509CertificateEntry CertificateEntry { get; set; }

    /// <summary>BouncyCastle X509CertificateEntry array containing the certificate chain.</summary>
